...
* link:https://www.ibm.com/docs/en/ibm-style[IBM Style Guide], especially link:https://www.ibm.com/docs/en/ibm-style?topic=word-usage[word usage]
+
NOTE: Use your Red Hat e-mail when asked for IBMid
...
For assemblies and task modules, use a gerund form in headings, such as:
